...
#define TVG_SHAPE_PATH_INDICATOR    (TvgIndicator)0x20 // Shape has path section
#define TVG_SHAPE_STROKE_INDICATOR  (TvgIndicator)0x21 // Shape has stroke section
#define TVG_SHAPE_FILL_INDICATOR    (TvgIndicator)0x22 // Shape has fill section
#define TVG_SHAPE_COLOR_INDICATOR   (TvgIndicator)0x23 // Shape has color
...
#define TVG_FILL_LINEAR_GRADIENT_INDICATOR  (TvgIndicator)0x40 // linear gradient flag
#define TVG_FILL_RADIAL_GRADIENT_INDICATOR  (TvgIndicator)0x41 // radial gradient flag
#define TVG_FILL_COLORSTOPS_INDICATOR       (TvgIndicator)0x42 // fill's colorStops flag
#define TVG_FILL_FILLSPREAD_INDICATOR       (TvgIndicator)0x43 // mask for fill spread
